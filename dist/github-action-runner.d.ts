import type { OutputSink, ProcessResult, RedactorPort, RunnerPort } from "@reviewrouter/subscription-runtime-core";
...
export declare class GitHubActionRunner implements RunnerPort {
    ...
    readonly capabilities: import("@reviewrouter/subscription-runtime-core").RunnerCapabilities;
